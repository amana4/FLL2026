...
> Some trees use a unique strategy to disperse their seeds. Release the seeds from the seed pod, propelling them to new ground.

## Scoring conditions

| Condition | Points |
| --- | --- |
| Seeds no longer touching the stalk | **10 each** |
