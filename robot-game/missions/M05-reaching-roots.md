# Mission 05 — Reaching Roots

> Scoring conditions below are quoted from the official BIOGLOW Robot Game
> Rulebook (page 10). **The rulebook and Challenge Updates are the only
...
> Rainforest plants stretch their roots far and wide, reaching resources and forming connections with nearby organisms. Help this plant cross the forest boundary in search of symbiosis.

## Scoring conditions

| Condition | Points |
| --- | --- |
| The plant root is **partially** extended | **10** |
| OR the plant root is **completely** extended | **20** |

**Maximum: 20 (either/or, not additive) points**

## Notes and gotchas

Mission model: Plant Root.
