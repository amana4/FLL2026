...
## Questions that come up in the Q&A segments

These arrive inside the Innovation Project or Robot Design Q&A, not in a session
of their own.

| Question | Our answer |
| --- | --- |
| Tell us about a time your team disagreed. | _TODO_ |
| How do you make sure everyone is included? | _TODO_ |
| What's the biggest challenge you overcame? | _TODO_ |
| What did you learn from another team? | _TODO_ |
| How did you divide the work? | _TODO_ |
| What failed, and what did you do about it? | _TODO_ |
| What does Gracious Professionalism mean to you? | _TODO_ — give an example, not a definition |
| What was the most fun part of the season? | _TODO_ |
| What would you do differently? | _TODO_ |

## How to behave in the room

- Let quieter teammates take questions they are comfortable with first.
- Don't interrupt each other. Judges watch this closely.
- If someone is stuck, "do you want to add to that?" is a good move — supporting
  each other is the thing being scored, not knowing everything.
- Answer honestly. Rehearsed answers land worse than real ones.

## All season, not just on the day

- [ ] Evidence log updated at every meeting
- [ ] Roles rotated, and the rotation logged
- [ ] We've done something for another team
- [ ] We've celebrated at least one useful failure
- [ ] Mission 07 raised with our match partner before the round — both teams score
      the bonus if both fully extend, which is Coopertition made literal
