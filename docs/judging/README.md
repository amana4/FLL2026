...
| File | Covers |
| --- | --- |
| [`innovation-project-prep.md`](innovation-project-prep.md) | The 5-minute presentation and its Q&A |
...
## Advice that applies to the whole session

**Everyone talks.** Judges track who spoke, and the rubric asks for evidence that
*all* team members contributed. One student answering everything costs points
however good the answers are. Agree roughly who covers what, then be ready to
...
**Talk about failures.** Every rubric rewards iteration. "This is version four,
and here is why one to three didn't work" outscores a flawless story with no
history.

## Mock judging

Run at least one full mock at **Meeting 21 (Sunday 18 October)** with an adult who
is not a coach and who will ask awkward questions.

Mock the real thing: one 30-minute sitting, both halves back to back, with the
2-minute setup and the transition included. Rehearsing the halves separately hides
exactly the problems a mock is for.
