...
## Making sure the loudest voice does not set the direction

The brainstorm page already does this with the layer-per-student split — everyone
works alone first, then shares. Generalise it:

- **Round-robin before open discussion.** Everyone says one thing before anyone says
  two.
- **Write before speaking** on decisions. Three minutes of silent notes, then read
  them out. It stops the first confident opinion becoming the group's opinion.
- **Deliberately ask the quiet person for their view** before closing a decision,
  and wait through the pause.
- **Rotate who reports back** to the whole group.

## The rotation is an inclusion mechanism

The three-week rotation in [`meeting-plan.md`](meeting-plan.md) is usually explained
as judging insurance, and it is. It is also how you avoid the pattern where one
student owns the robot all season and another owns the glue stick.

If someone is drifting toward being the person who never codes, move them into
coding at the next rotation and pair them with whoever just left it.

## Asking families what is needed

Ask once, early, privately, and without making it a thing:

> "Is there anything I should know that would make the sessions or the competition
> day work better for your child? Happy to hear about anything — noise, reading,
> medication, needing a break, whatever it is."

Then act on it without announcing it.

- [ ] Asked each family before the first event
- [ ] Accommodations requested from the event organiser where needed
- [ ] Everyone has a prepared speaking part they can deliver
- [ ] Homework substitutions offered where written work is a barrier

## What to write in the evidence log

Inclusion is easy to believe you are doing and hard to evidence. The specific moments
worth recording in
[`evidence-log.md`](../core-values/evidence-log.md): a time someone quieter was given
the lead, a time the team changed how it worked so somebody could take part, a time a
decision went to the person who had not spoken.

Judges ask "how do you make sure everyone is included?" and a real story beats a
