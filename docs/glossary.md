...
| **Hub** | The programmable controller. **Max one per match.** |
| **Gyro** | The hub's orientation sensor, used for accurate turns. |
| **FIRST® CANOPY™** | The 2026–27 *FIRST* season umbrella. BIOGLOW is the FLL Challenge division. |
