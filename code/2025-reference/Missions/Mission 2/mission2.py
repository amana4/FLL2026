...
async def run_mission2():
    # Move forward
    await drive_cm(-65, velocity=300)
    # Turn
    await turn_deg(-55, velocity=600)
    #Move forward
    await drive_cm(-20, velocity=400)
    #1 inch for the hand in the middle
    ...
    # Turn
    #await turn_deg(-40, velocity=600)
        # Turn
    #await turn_deg(130, velocity=600)

#async def run_mission2():
    # Move forward
    #await drive_cm(30, velocity=600)
    # Turn
    #await turn_deg(121, velocity=600)
    # Move forward
    #await drive_cm(-30, velocity=250)

    #await move_attachment_deg(port.C, -60, 1000)
