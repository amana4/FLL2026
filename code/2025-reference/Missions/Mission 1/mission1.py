...
async def run_mission1():
    # Move forward
    await drive_cm(-58, velocity=600)
    # Turn
    await turn_deg(-70, velocity=600)
    #Move forward
    await drive_cm(-10, velocity=200)
    # Turn
    ...
    await drive_cm(10, velocity=200)
    #Turn
    await turn_deg(-20, velocity=600)
    #drive forward
    await drive_cm(-12, velocity=200)

    await motor.run_for_degrees(port.C, 60, 200)

    await turn_deg (-90, velocity=200)

    await drive_cm (-55, velocity=200)
