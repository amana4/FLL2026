...
async def run_mission1():
    await motor.run_for_degrees(port.C, -162, 200)
    # Move forward
    await drive_cm(-48, velocity=1000)
    # Turn
    await turn_deg(-70, velocity=1000)
    #Move forward
    await drive_cm(-4, velocity=1000)
    # hit
    await turn_deg(-70, velocity=1000)
    await turn_deg(70, velocity=1000)
    #Drive back
    ...
    #pick up mission 1
    await drive_cm (3)
    await drive_cm (-11, velocity= 200)
    await motor.run_for_degrees(port.C, 60, 100)
    await drive_cm (5)
    await turn_deg (-90)
    await drive_cm(-50)
