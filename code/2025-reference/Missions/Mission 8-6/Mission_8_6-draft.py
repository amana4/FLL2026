# this code will start with mission 8 and then 6 in one round
# Mission 8_6
...
async def run_mission8_6():
    ...
    await drive_cm(-38,velocity=1000)
    await run_attachment_deg(attachment1, -400, velocity=1110)
    # # # # #start hitting red lever
    await run_attachment_deg(attachment1, 500, velocity=1110)
    await run_attachment_deg(attachment1, -500, velocity=1110)
    await run_attachment_deg(attachment1, 500, velocity=1110)
    await run_attachment_deg(attachment1, -500, velocity=1110)
    await run_attachment_deg(attachment1, 500, velocity=1110)
    ...
    await turn_deg(-75) # may need to change to backup without hitting the silo
    await turn_deg(-100)
    await drive_cm(30)
    await drive_cm(-40)
    await turn_deg(-100)
