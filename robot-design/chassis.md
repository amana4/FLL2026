...
| Wheelbase | _TODO_ | |
| Castor / third point | _TODO_ | |
| Attachment motors | _TODO — ports_ | |
| Hub position | _TODO_ | Affects weight balance and button access |

## Sensors

| Sensor | Port | Position | Used for |
| --- | --- | --- | --- |
| Gyro (built in) | — | Hub | Straight driving, accurate turns |
| Colour | _TODO_ | _TODO_ | Line following / squaring |
...
_TODO — describe the mount: pin positions, axle alignment, motor coupling_

**Swap time:** _TODO_ s (target: under 10)
